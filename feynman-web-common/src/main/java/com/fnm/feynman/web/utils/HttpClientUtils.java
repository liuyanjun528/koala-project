...
public class HttpClientUtils {
    ...
    public static JWT httpPost(String username, String password,String loginType) throws IOException {
        CloseableHttpClient httpClient = HttpClientBuilder.create().build();
        HttpPost httpPost = new HttpPost("http://121.89.172.92:3333/oauth/token");
        ...
        BasicNameValuePair param6 = new BasicNameValuePair("loginType", loginType);
        list.add(param1);
        list.add(param2);
        list.add(param3);
        list.add(param4);
