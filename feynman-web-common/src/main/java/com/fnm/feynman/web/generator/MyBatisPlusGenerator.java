package com.fnm.feynman.web.generator;
...
public class MyBatisPlusGenerator {
    private static final String PACKAGE = "com.fnm.feynman.web";
    ...
    private static final String PATH_MAPPER  = "./src/main/java/com/fnm/feynman/web/";
    private static final String PATH_MAPPER_XML = "./src/main/resources/mapper/";
    private static final String PATH_CONTROLLER = "./src/main/java/com/fnm/feynman/web/";
    private static final String PATH_SERVICE = "./src/main/java/com/fnm/feynman/web/";
    private static final String PATH_SERVICE_IMP = "./src/main/java/com/fnm/feynman/web/";
    private static final String PATH_ENTITY = "./src/main/java/com/fnm/feynman/web/";
